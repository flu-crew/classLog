<p align="center">
  <img src=https://github.com/flu-crew/classLog/blob/master/img/logo.png">
</p>
...
>If `nan` is returned in the classes list, that indicates that some seuqences have not been given a designation. The `predictmissing` subcommand can be used to 
